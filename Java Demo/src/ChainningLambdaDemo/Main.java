...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Combine 1 = " + combined1.test(name));

        Predicate<String> combined2 = p3.and(p4);
        System.out.println("Combine 2 = " + combined2.test(name));

        Predicate<String> combined3 = p3.and(p4).negate();
        System.out.println("Combine 4 = " + combined3.test(name));
